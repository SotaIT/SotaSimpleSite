<%@ Control Language="c#" AutoEventWireup="false" Codebehind="template.ascx.cs" Inherits="Sota.Web.SimpleSite.Code.Admin.template" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
&nbsp;<a href="?new=">Добавить шаблон</a><br><br>
<form method="post" action="<%=Path.Full%>">
	<asp:datagrid id="dgTemplate" width="100%" bordercolor="#0000C0" borderstyle="Double" borderwidth="3px" cellpadding="4" runat="server" autogeneratecolumns="False">
		...
		<columns>
			...
			<asp:templatecolumn headertext="Файл">
				...
				<edititemtemplate>
					<select name="cmbFile"><%#GetTemplates(DataBinder.Eval(Container.DataItem, "file").ToString())%></select>
				</edititemtemplate>
			</asp:templatecolumn>
			<asp:templatecolumn>
